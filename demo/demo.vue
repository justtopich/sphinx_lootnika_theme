...
<p>Also with <code class="docutils literal notranslate"><span class="pre">sphinx.ext.autodoc</span></code>, which I use in the demo, I can link to <router-link class="reference internal" href="api" to="api#test_py_module-test-Foo" v-scroll-to="'api#test_py_module-test-Foo'"><code class="xref py py-class docutils literal notranslate"><span class="pre">test_py_module.test.Foo</span></code></router-link>.
It will link you right to my code documentation for it.</p>
...
<span class="eqno">(1)<a class="headerlink" href="#equation-this-is-a-label" title="Permalink to this equation">¶</a></span>\[\nabla^2 f =
...
Thus the hexagram includes also the power of time and the power of persisting in time, that is, duration.</p>
<p>The power represented by the hexagram is to be interpreted in a dual sense in terms of its action
...
<a class="reference internal" href="#targets">Targets</a>, which is a subsection of <a href="#id34"><span class="problematic" id="id35">`Body Elements`_</span></a>.</p>
...
<tr class="row-even"><td><p>Structured</p></td>
...
<li><p>Clean up your room.</p>
<ul>
<li><p>Including the closet.</p></li>
<li><p>The bathroom too.</p>
<ul>
<li><p>Take the trash out of the bathroom.</p></li>
<li><p>Clean the sink.</p></li>
</ul>
</li>
</ul>
</li>
...
<tbody>
<tr class="row-even"><td><p>Thing1</p></td>
</tr>
<tr class="row-odd"><td><p>Thing2</p></td>
</tr>
<tr class="row-even"><td><p>Thing3</p></td>
</tr>
</tbody>
</table>
</div>
